...
* **SQL (SSMS)** – Data cleaning and analysis
* **Google Sheets** – Data visualization and dashboard creation
...
These steps ensured the dataset was reliable for generating meaningful insights.
...
This dashboard enables users to quickly understand major patterns within the startup ecosystem.
